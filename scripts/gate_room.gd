...
const THROW_TUMBLE_BASE: float = 5.746     # head-over-heels tumble rate (rad/s) — limbs swing
const THROW_TUMBLE_DIST: float = 0.303    # extra tumble per metre of downrange throw
