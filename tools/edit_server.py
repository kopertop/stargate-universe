...
Usage: python3 tools/edit_server.py [port]   (serves the repo root; .claude/launch.json does this)
Only these paths accept PUT (JSON body, validated): data/*.json
"""
...
WRITABLE = re.compile(r'^/data/[A-Za-z0-9_\-]+\.json$')
