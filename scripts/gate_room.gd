...
const THROW_TUMBLE_BASE: float = 5.281     # head-over-heels tumble rate (rad/s) — limbs swing
const THROW_TUMBLE_DIST: float = 0.406    # extra tumble per metre of downrange throw
