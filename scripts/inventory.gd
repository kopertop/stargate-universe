...
# below report the no-effect baseline. The follow-up work: (a) authors `effects`
...
# SEAM: head-slot helmet → off-world atmosphere protection (#75 follow-up hook).
...
# SEAM: back-slot pack → carry-capacity modifier (#75 follow-up hook).
