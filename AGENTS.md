...
`~/.Codex/skills/` (or the engine's `skills/` directory). The most relevant skills are:
...
- `@.Codex/docs/coordination-rules.md` — agent coordination rules
- `@.Codex/docs/coding-standards.md` — detailed coding standards
- `@.Codex/docs/context-management.md` — context management across sessions
